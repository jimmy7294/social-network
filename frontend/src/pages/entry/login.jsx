        ...
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form className="space-y-6" action="#" method="POST">
              <div>
                <label htmlFor="email" className="block text-md font-american-type-writer leading-6 text-gray-900">
                  Email address
                </label>
                <div className="mt-2">
                  <input
              ...
              <div>
                <div className="flex items-center justify-between">
                  <label htmlFor="password" className="block text-md font-american-type-writer leading-6 text-gray-900">
                    Password
                  </label>
                  <div className="text-md">
                    <a href="#" className="font-american-type-writer text-indigo-600 hover:text-indigo-500">
                      Forgot password?
                    </a>
                  </div>
                </div>
            ...
            <p className="mt-10 text-center text-md text-gray-500">
              Not a user?{' '}
              <Link href="/entry/register" className="font-american-type-writer leading-6 text-indigo-600 hover:text-indigo-500">
                Register here
              </Link>
            </p>
          </div>
